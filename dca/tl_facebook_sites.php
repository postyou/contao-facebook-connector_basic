    ...
    'list' => array(
        ...
        'operations' => array(
            'editPosts' => array(
                ...
                'icon' => 'system/modules/contao-facebook-connector_basic/assets/img/post.png',
            ...
            'editEvents' => array(
                ...
                'icon' => 'system/modules/contao-facebook-connector_basic/assets/img/event.png',
                'button_callback' => array(
                    'tl_facebook_sites_basic',
                    'disableButton'
                )
            ...
            'editGalleries' => array(
                ...
                'icon' => 'system/modules/contao-facebook-connector_basic/assets/img/gallery.png',
                'button_callback' => array(
                    'tl_facebook_sites_basic',
                    'disableButton'
                )
...
class tl_facebook_sites_basic extends \Backend
{
    ...
    protected function loginButton($showExplanation = true)
    {
        return ($showExplanation ? '<div class="tl_help loginExplanation">'.
             ...
             '<a id="facebookLogin" class="tl_submit disabled">' . $GLOBALS['TL_LANG']['tl_facebook_sites']['facebookLoginLink'] . '</a>';
    }
    ...
    public function generateReportMarkup()
    {
        ...
        $html = '<div class="clr" id="synchronizeReport"><h2>Synchronisations &Uuml;berblick:</h2>';
